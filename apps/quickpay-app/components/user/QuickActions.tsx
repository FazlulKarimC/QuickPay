...
export function QuickActions() {
    const actions = [
        { label: "Send Money", icon: Send, href: "/user/p2p", color: "text-indigo-600 bg-indigo-50 dark:bg-indigo-900/20 dark:text-indigo-400" },
        { label: "Add Money", icon: Plus, href: "/user/transfer", color: "text-green-600 bg-green-50 dark:bg-green-900/20 dark:text-green-400" },
        { label: "History", icon: History, href: "/user/transactions", color: "text-orange-600 bg-orange-50 dark:bg-orange-900/20 dark:text-orange-400" },
    ];
